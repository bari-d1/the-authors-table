const EXCERPT_TARGET_WORDS = 150
...
// original order) that together run to roughly targetWords - the matched
// passage plus enough surrounding context to make sense of it, not the
// whole chapter. Expansion alternates sides so the match stays roughly
// centered rather than the excerpt skewing entirely forward or back.
