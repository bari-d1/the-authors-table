...
// Pulled from the uilayouts registry (npx uilayouts add liquid-glass),
// converted from its .tsx source to plain .jsx by hand since this project
// has no TypeScript setup - the CLI's own interactive language prompt
// requires a real TTY, which isn't available in this environment, so the
// same registry source was fetched directly and stripped of type
// annotations instead. Behavior is unchanged from the original.
